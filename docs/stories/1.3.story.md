...
interface Employee {
  ...
  status_kepegawaian: 'active' | 'inactive' | 'terminated' | 'on_leave' | 'probation' | 'contract' | 'suspended';
...
*This story was created using BMad create-next-story methodology on 2025-09-30 for KAEF HRIS Employee Master Data Epic 1.3.*