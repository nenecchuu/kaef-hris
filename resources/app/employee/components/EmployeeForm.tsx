...
import type { Employee, CreateEmployeeData, UpdateEmployeeData, EmploymentStatus, EmploymentType } from '../types';
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            {errors.nomor_karyawan && (
              <p className="mt-1 text-sm text-red-600">{errors.nomor_karyawan.message}</p>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            {errors.tanggal_masuk && (
              <p className="mt-1 text-sm text-red-600">{errors.tanggal_masuk.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.status_kepegawaian && (
              <p className="mt-1 text-sm text-red-600">{errors.status_kepegawaian.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors.jenis_kepegawaian && (
              <p className="mt-1 text-sm text-red-600">{errors.jenis_kepegawaian.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.divisi_id && (
              <p className="mt-1 text-sm text-red-600">{errors.divisi_id.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.jabatan_id && (
              <p className="mt-1 text-sm text-red-600">{errors.jabatan_id.message}</p>
            )}
          </div>
        </div>
      </div>
