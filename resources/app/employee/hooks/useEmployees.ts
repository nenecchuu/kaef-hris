...
import type { Employee, ApiResponse, EmployeeFilters } from '../types';
...
async function fetchEmployees(
  ...
  if (filters.divisi_id) params.append('divisi_id', filters.divisi_id.toString());
  if (filters.jabatan_id) params.append('jabatan_id', filters.jabatan_id.toString());
