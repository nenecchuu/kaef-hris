...
import { NativeSelectPrimitive } from "./native-select-primitive";

/** @typedef {(string|import('./native-select-primitive').NativeSelectOptionType)} NativeSelectOptionType */
/**
 ...
 * @prop {NativeSelectOptionType[]} options The options that will be rendered in select dropdown.
 ...
 * @prop {((value: NativeSelectOptionType) => void)=} onValueChange Event handler called when the value changes.
 */
/** @type {React.ForwardRefExoticComponent<NativeSelectProps>} props */
